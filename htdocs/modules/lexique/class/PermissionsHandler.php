...
class PermissionsHandler extends \XoopsPersistableObjectHandler
{
    ...
    public function getPermGlobalApprove()
    {
        ...
        if ($grouppermHandler->checkRight('lexique_ac', 4, $my_group_ids, $mid)) {
            return true;
        }
        return false;
    }
    ...
    public function getPermGlobalSubmit()
    {
        ...
        if ($grouppermHandler->checkRight('lexique_ac', 8, $my_group_ids, $mid)) {
            return true;
        }
        return false;
    }
    ...
    public function getPermGlobalView()
    {
        ...
        if ($grouppermHandler->checkRight('lexique_ac', 16, $my_group_ids, $mid)) {
            return true;
        }
        return false;
    }
