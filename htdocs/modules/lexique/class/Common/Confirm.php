...
class Confirm
{
    ...
    public function getFormConfirm()
    {
        ...
        if (!\defined('_CO_LEXIQUE_DELETE_CONFIRM')) {
            \define('_CO_LEXIQUE_DELETE_CONFIRM', 'Confirm delete');
            \define('_CO_LEXIQUE_DELETE_LABEL', 'Do you really want to delete:');
        }
        ...
        if ('' === $this->title) {
            $this->title = \constant('_CO_LEXIQUE_DELETE_CONFIRM');
        }
        if ('' === $this->label) {
            $this->label = \constant('_CO_LEXIQUE_DELETE_LABEL');
        }
