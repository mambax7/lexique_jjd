...
\define('_MI_LEXIQUE_ADMENU2', "Lists");
\define('_MI_LEXIQUE_ADMENU3', "Labels");
\define('_MI_LEXIQUE_ADMENU4', "Lists");
\define('_MI_LEXIQUE_ADMENU5', "Lexiques");
\define('_MI_LEXIQUE_ADMENU6', "Propertys");
\define('_MI_LEXIQUE_ADMENU7', "Terms");
\define('_MI_LEXIQUE_ADMENU8', "Values");
...
// ---------------- End ----------------
\define('_MI_LEXIQUE_MAXSIZE_IMAGE', "Taille max des images");
\define('_MI_LEXIQUE_MAXSIZE_IMAGE_DESC', "Taille max des images");
\define('_MI_LEXIQUE_MIMETYPES_IMAGE', "Type d'image");
\define('_MI_LEXIQUE_MIMETYPES_IMAGE_DESC', "");
\define('_MI_LEXIQUE_MAXWIDTH_IMAGE', "Largeur maximum");
\define('_MI_LEXIQUE_MAXWIDTH_IMAGE_DESC', "");
\define('_MI_LEXIQUE_MAXHEIGHT_IMAGE', "Hauteur maximum");
\define('_MI_LEXIQUE_MAXHEIGHT_IMAGE_DESC', "");
